...
struct ParamPack
{
	ParamPack() :isLocalTrace_(false), enableSVM_(false), strongSignalMode_(true), enableGPSSVM_(false), curTraceTopoID_(0), dataMode_(READMODE::INVALID), filterNum_(5), threadNum_(omp_get_max_threads()), xScale_(1), yScale_(1), zScale_(1),
		isAverageResample(1), maxBoundNum_(10), thicknesss_(10.0), lowOpac_(0), highOpac_(1000), lowAdjustOpac_(0), highAdjustOpac_(0), lowDestOpac_(0), highDestOpac_(0),
		...
		mostdLevel_(1), maxValue_(4096), b(0.0), runningMinutes_(0), smooth_level(0.01), isBigSoma(false), isCrudeShape(false){
