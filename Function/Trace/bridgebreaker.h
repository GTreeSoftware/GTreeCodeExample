...
public:
    ...
    void SetInputOrigImage(ConstIDataPointer arg){m_OrigImg = arg;}
    void SetInputTree(ConstIDataPointer arg){m_Tree = arg;}
    //2015-3-3 add work status
    void SetInputSoma(ConstIDataPointer arg){m_Soma = arg;}
...
private:
    //variant
    ConstIDataPointer m_OrigImg;
    ConstIDataPointer m_Tree;
    VectorVec4d resultIndex;
    ConstIDataPointer m_Soma;//2015-3-3
    //function
