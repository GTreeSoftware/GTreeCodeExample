...
struct Vec5d_3th_less{
    bool operator() (const Vec5d& lhs, const Vec5d& rhs){
        return lhs(3) < rhs(3);
    }
};
...
//2015-10-9
void LimitRange(int xMin, int xMax, int yMin, int yMax, int zMin, int zMax, 
				int &dstXMin, int &dstXMax, int &dstYMin, int &dstYMax, int &dstZMin, int &dstZMax );
