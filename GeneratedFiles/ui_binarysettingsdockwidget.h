...
public:
    ...
    void setupUi(QDockWidget *BinarySettingsDockWidget)
    {
        ...
        BinarySettingsDockWidget->resize(411, 893);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(BinarySettingsDockWidget->sizePolicy().hasHeightForWidth());
        BinarySettingsDockWidget->setSizePolicy(sizePolicy);
        BinarySettingsDockWidget->setMinimumSize(QSize(290, 137));
        BinarySettingsDockWidget->setFocusPolicy(Qt::WheelFocus);
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 409, 869));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/new/tracer/Resource/plus.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QStringLiteral(":/new/tracer/Resource/minus.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        imageRangeLabel = new QLabel(widget);
        ...
        xMinspinBox = new QSpinBox(widget);
        ...
        xMaxspinBox = new QSpinBox(widget);
        ...
        yMinspinBox = new QSpinBox(widget);
        ...
        yMaxspinBox = new QSpinBox(widget);
        ...
        zMinspinBox = new QSpinBox(widget);
        ...
        zMaxspinBox = new QSpinBox(widget);
        ...
        levelSpinBox = new QSpinBox(widget);
        ...
        applyImageReadButton = new QPushButton(widget);
        ...
        action_ClearCache_Button = new QPushButton(widget);
        ...
        highOpacSpinBox->setMaximum(9999);
        ...
        gridLayout_24->addWidget(widget_3, 5, 0, 1, 2);
        ...
        gridLayout_24->addWidget(pushButton_11, 6, 0, 1, 1);

        horizontalSpacer_10 = new QSpacerItem(75, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_24->addItem(horizontalSpacer_10, 6, 1, 1, 1);
        ...
        gridLayout_24->addWidget(widget_4, 7, 0, 1, 2);

        verticalSpacer_3 = new QSpacerItem(20, 233, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_24->addItem(verticalSpacer_3, 8, 0, 1, 2);
        ...
        gridLayout_21->addItem(verticalSpacer, 3, 0, 1, 1);
        ...
        histogramLabel = new QLabel(tab_2);
        histogramLabel->setObjectName(QStringLiteral("histogramLabel"));
        sizePolicy2.setHeightForWidth(histogramLabel->sizePolicy().hasHeightForWidth());
        histogramLabel->setSizePolicy(sizePolicy2);
        histogramLabel->setMinimumSize(QSize(140, 255));
        histogramLabel->setMaximumSize(QSize(140, 255));

        gridLayout_21->addWidget(histogramLabel, 2, 0, 1, 2);

        widget_15 = new QWidget(tab_2);
        widget_15->setObjectName(QStringLiteral("widget_15"));
        gridLayout_19 = new QGridLayout(widget_15);
        gridLayout_19->setObjectName(QStringLiteral("gridLayout_19"));
        GPSSVMcheckBox = new QCheckBox(widget_15);
        GPSSVMcheckBox->setObjectName(QStringLiteral("GPSSVMcheckBox"));

        gridLayout_19->addWidget(GPSSVMcheckBox, 2, 0, 1, 1);
        ...
        BigSomacheckBox = new QCheckBox(widget_15);
        BigSomacheckBox->setObjectName(QStringLiteral("BigSomacheckBox"));

        gridLayout_19->addWidget(BigSomacheckBox, 3, 0, 1, 1);
        ...
        gridLayout_22 = new QGridLayout(widget_17);
        ...
        gridLayout_23 = new QGridLayout(widget_18);
        gridLayout_23->setSpacing(1);
        gridLayout_23->setObjectName(QStringLiteral("gridLayout_23"));
        gridLayout_23->setContentsMargins(1, 1, 1, 1);
        axonThresholdSpinBox = new QDoubleSpinBox(widget_18);
        ...
        ThresholdLabel_5 = new QLabel(widget_18);
        ...
        previewAxonBinaryButton = new QPushButton(widget_18);
        ...
        gridLayout_22->addWidget(widget_18, 1, 0, 1, 1);


        gridLayout_5->addWidget(widget_17, 0, 0, 1, 1);
        ...
        axonTraceValueSpinBox = new QDoubleSpinBox(widget_5);
        ...
        diffuseValueLabel_2 = new QLabel(widget_5);
        ...
        axonSemiautoTraceTresholdSpinBox = new QDoubleSpinBox(widget_5);
        ...
        maxBoundNumSpinBox = new QSpinBox(widget_5);
        ...
        axonDiffuseValueSpinBox = new QDoubleSpinBox(widget_5);
        ...
        strongSignalCheckBox = new QCheckBox(widget_5);
        ...
        enableSVMBox = new QCheckBox(widget_5);
        ...
        axonSemiautoConnectResampleSpinBox = new QDoubleSpinBox(widget_5);
        ...
        gridLayout_3->addWidget(widget_5, 1, 0, 1, 2);
        ...
        SmoothSlider = new QSlider(widget_13);
        ...
        pushButton_12 = new QPushButton(widget_19);
        ...
        gridLayout_25->addWidget(pushButton_12, 0, 0, 1, 1);

        horizontalSpacer_11 = new QSpacerItem(94, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_25->addItem(horizontalSpacer_11, 0, 1, 1, 1);

        CrudeShapecheckBox = new QCheckBox(widget_19);
        CrudeShapecheckBox->setObjectName(QStringLiteral("CrudeShapecheckBox"));

        gridLayout_25->addWidget(CrudeShapecheckBox, 1, 0, 1, 2);


        gridLayout_5->addWidget(widget_19, 3, 0, 1, 1);
        ...
        BinarySettingsDockWidget->setWidget(dockWidgetContents);
        ...
        QWidget::setTabOrder(action_ClearCache_Button, lowOpacSpinBox);
        QWidget::setTabOrder(lowOpacSpinBox, highOpacSpinBox);
        QWidget::setTabOrder(highOpacSpinBox, xBlockSizespinBox);
        QWidget::setTabOrder(xBlockSizespinBox, yBlockSizespinBox);
        QWidget::setTabOrder(yBlockSizespinBox, zBlockSizespinBox);
        QWidget::setTabOrder(zBlockSizespinBox, xScaleSpinBox);
        QWidget::setTabOrder(xScaleSpinBox, yScaleSpinBox);
        QWidget::setTabOrder(yScaleSpinBox, zScaleSpinBox);
        QWidget::setTabOrder(zScaleSpinBox, thresholdSpinBox);
        QWidget::setTabOrder(thresholdSpinBox, diffuseValueSpinBox);
        QWidget::setTabOrder(diffuseValueSpinBox, traceValueSpinBox);
        QWidget::setTabOrder(traceValueSpinBox, axonDiffuseValueSpinBox);
        ...
        QWidget::setTabOrder(maxBoundNumSpinBox, enableSVMBox);
        QWidget::setTabOrder(enableSVMBox, strongSignalCheckBox);
        QWidget::setTabOrder(strongSignalCheckBox, pushButton_3);
        ...
        QWidget::setTabOrder(scrollArea, pushButton_8);
        ...
        QObject::connect(pushButton_3, SIGNAL(clicked(bool)), widget_5, SLOT(setVisible(bool)));
        QObject::connect(pushButton_5, SIGNAL(clicked(bool)), widget_13, SLOT(setVisible(bool)));
        ...
        QObject::connect(pushButton_9, SIGNAL(clicked(bool)), widget_3, SLOT(setVisible(bool)));
        QObject::connect(pushButton_10, SIGNAL(clicked(bool)), widget_18, SLOT(setVisible(bool)));
    ...
    {
        BinarySettingsDockWidget->setWindowTitle(QApplication::translate("BinarySettingsDockWidget", "BinarySettings", 0));
        pushButton->setText(QApplication::translate("BinarySettingsDockWidget", "Image Range", 0));
        imageRangeLabel->setText(QApplication::translate("BinarySettingsDockWidget", "Image Size:", 0));
        xMinLabel->setText(QApplication::translate("BinarySettingsDockWidget", "xMin", 0));
        xMaxLabel->setText(QApplication::translate("BinarySettingsDockWidget", "xMax", 0));
        yMinLabel->setText(QApplication::translate("BinarySettingsDockWidget", "yMin", 0));
        yMaxLabel->setText(QApplication::translate("BinarySettingsDockWidget", "yMax", 0));
        zMinLabel->setText(QApplication::translate("BinarySettingsDockWidget", "zMin", 0));
        zMaxLabel->setText(QApplication::translate("BinarySettingsDockWidget", "zMax", 0));
        label_3->setText(QApplication::translate("BinarySettingsDockWidget", "Level", 0));
        applyImageReadButton->setText(QApplication::translate("BinarySettingsDockWidget", "Apply Read", 0));
        action_ClearCache_Button->setText(QApplication::translate("BinarySettingsDockWidget", "Clear Cache", 0));
        pushButton_4->setText(QApplication::translate("BinarySettingsDockWidget", "Display", 0));
        lowMapLabel->setText(QApplication::translate("BinarySettingsDockWidget", "Min Opac", 0));
        highMapLabel->setText(QApplication::translate("BinarySettingsDockWidget", "Max Opac", 0));
        label_5->setText(QApplication::translate("BinarySettingsDockWidget", "Thickness", 0));
        pushButton_6->setText(QApplication::translate("BinarySettingsDockWidget", "Block Radius", 0));
        highMapLabel_2->setText(QApplication::translate("BinarySettingsDockWidget", "yBlock", 0));
        lowMapLabel_2->setText(QApplication::translate("BinarySettingsDockWidget", "xBlock", 0));
        highMapLabel_3->setText(QApplication::translate("BinarySettingsDockWidget", "zBlock", 0));
        pushButton_9->setText(QApplication::translate("BinarySettingsDockWidget", "Resample", 0));
        label_7->setText(QApplication::translate("BinarySettingsDockWidget", "zScale", 0));
        label_6->setText(QApplication::translate("BinarySettingsDockWidget", "yScale", 0));
        label->setText(QApplication::translate("BinarySettingsDockWidget", "xScale", 0));
        pushButton_11->setText(QApplication::translate("BinarySettingsDockWidget", "Illuminant", 0));
        label_8->setText(QApplication::translate("BinarySettingsDockWidget", "Original", 0));
        label_11->setText(QApplication::translate("BinarySettingsDockWidget", "|", 0));
        label_12->setText(QApplication::translate("BinarySettingsDockWidget", "|", 0));
        label_10->setText(QApplication::translate("BinarySettingsDockWidget", "Dest", 0));
        previewIlluminationMapButton->setText(QApplication::translate("BinarySettingsDockWidget", "Preview", 0));
        imageOpacInfoButton->setText(QApplication::translate("BinarySettingsDockWidget", "Info", 0));
        opacApplyButton->setText(QApplication::translate("BinarySettingsDockWidget", "Apply", 0));
        autoOpacSetCheckBox->setText(QApplication::translate("BinarySettingsDockWidget", "Auto", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("BinarySettingsDockWidget", "Image", 0));
        histogramLabel->setText(QString());
        GPSSVMcheckBox->setText(QApplication::translate("BinarySettingsDockWidget", "GPS-SVM", 0));
        pushButton_8->setText(QApplication::translate("BinarySettingsDockWidget", "Trace Option", 0));
        diffuseValueLabel_4->setText(QApplication::translate("BinarySettingsDockWidget", "Bifur", 0));
        label_9->setText(QApplication::translate("BinarySettingsDockWidget", "Trace", 0));
        BigSomacheckBox->setText(QApplication::translate("BinarySettingsDockWidget", "Big Soma", 0));
        pushButton_7->setText(QApplication::translate("BinarySettingsDockWidget", "Binary Option", 0));
        ThresholdLabel_4->setText(QApplication::translate("BinarySettingsDockWidget", "Threshold", 0));
        previewBinaryButton->setText(QApplication::translate("BinarySettingsDockWidget", "Preview", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("BinarySettingsDockWidget", "NeuroGPS", 0));
        pushButton_10->setText(QApplication::translate("BinarySettingsDockWidget", "Binary Option", 0));
        ThresholdLabel_5->setText(QApplication::translate("BinarySettingsDockWidget", "Threshold", 0));
        previewAxonBinaryButton->setText(QApplication::translate("BinarySettingsDockWidget", "Preview", 0));
        pushButton_3->setText(QApplication::translate("BinarySettingsDockWidget", "Trace Option", 0));
        diffuseValueLabel_2->setText(QApplication::translate("BinarySettingsDockWidget", "Axon Bifur", 0));
        label_13->setText(QApplication::translate("BinarySettingsDockWidget", "Semi Rate(%)", 0));
        label_4->setText(QApplication::translate("BinarySettingsDockWidget", "Bound MaxNum", 0));
        strongSignalCheckBox->setText(QApplication::translate("BinarySettingsDockWidget", "Strong Noise", 0));
        enableSVMBox->setText(QApplication::translate("BinarySettingsDockWidget", "Enable SVM", 0));
        label_14->setText(QApplication::translate("BinarySettingsDockWidget", "Resample Distance", 0));
        label_2->setText(QApplication::translate("BinarySettingsDockWidget", "Axon Trace", 0));
        pushButton_5->setText(QApplication::translate("BinarySettingsDockWidget", "Smooth Option", 0));
        lowMapLabel_3->setText(QApplication::translate("BinarySettingsDockWidget", "Smooth Level", 0));
        pushButton_12->setText(QApplication::translate("BinarySettingsDockWidget", "Reconstruction", 0));
        CrudeShapecheckBox->setText(QApplication::translate("BinarySettingsDockWidget", "Crude fiber shape reconstruction", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("BinarySettingsDockWidget", "Axon", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("BinarySettingsDockWidget", "Editor", 0));
    } // retranslateUi
